...
i = 0
for (_, joint_states, _), (_, checkerboard_pose, _) in zip( bag.read_messages(topics=['joints']), bag.read_messages(topics=['chessboard']) ):
  ...
  cMo = Transform( [ checkerboard_pose.pose.position.x, checkerboard_pose.pose.position.y, checkerboard_pose.pose.position.z, checkerboard_pose.pose.orientation.x, checkerboard_pose.pose.orientation.y, checkerboard_pose.pose.orientation.z, checkerboard_pose.pose.orientation.w ] )
